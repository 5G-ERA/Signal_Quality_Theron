...
from pcl_interfaces.srv import AppendPcl,EdgeSwitchover, PartialMapRequest
import sensor_msgs_py.point_cloud2 as pcl2
import math
import requests
import json
...
class PointCloudSaverNode(Node):
    def __init__(self):
        super().__init__('edge_swithchover_node')
    ...
    def edge_switchover_callback(self, msg, response):
        ...
        try:
            ...
            if httpResponse.status_code == 200:
                ...
                print("Succesfl Swithc")
            else: 

                response.success = False
                response.message = 'Unsuccessfull switched'                
                print("Unsuccesfl Swithc")
